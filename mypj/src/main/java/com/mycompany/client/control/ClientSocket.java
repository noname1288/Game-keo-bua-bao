...
//                    state = ClientState.INFO_ANOTHER_PLAYER;
    ...
    public void getListRoom() {
        try {
            objOut.writeObject(new Message(MessageAction.LIST_ROOM, null));
            objOut.flush();
        } catch (IOException e) {
        }
    }
    ...
    public void enterRoom(int IDRoom) {
        try {
            objOut.writeObject(new Message(MessageAction.ENTER_ROOM, IDRoom));
        } catch (Exception e) {
        }
    }
    ...
    public void getRankList() {
        try {
            objOut.writeObject(new Message(MessageAction.RANK_LIST, null));
        } catch (Exception e) {
        }
    }
